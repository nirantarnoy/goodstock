...
$this->title = Yii::t('app', 'Vendorgroups');
...
<div class="vendorgroup-index">
    ...
    <p>
        <?= Html::a(Yii::t('app', 'Create Vendorgroup'), ['create'], ['class' => 'btn btn-success']) ?>
    </p>
    ...
    <div class="x_panel">
                  ...
                  <div class="x_content">
                        <div class="row">
                          <div class="col-lg-10">
                            <form id="form-perpage" class="form-inline" action="<?=Url::to(['vendorgroup/index'],true)?>" method="post">
