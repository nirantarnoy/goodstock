                  ...
                  <div class="x_content">
                    <br />
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ชื่อคลังสินค้า <span class="required">*</span>
                                </label>
                              ...
                              <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ตั้งเป็นคลังสินค้าตั้งต้น 
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                   <?php echo $form->field($model, 'is_primary')->widget(Switchery::className(),['options'=>['label'=>'','class'=>'form-control']])->label(false) ?>
                                </div>
                              </div>
                               <div class="form-group">
