...
<div class="warehouse-index">
    ...
    <?php // echo $this->render('_search', ['model' => $searchModel]); ?>
        <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างคลังสินค้า'), ['create'], ['class' => 'btn btn-success']) ?>
    <div class="x_panel">
                  <div class="x_title">
                  ...
                  <div class="x_content">
                        <div class="row">
                          ...
                          <div class="col-lg-3">
                            ...
                            <form id="form-perpage" class="form-inline" action="<?=Url::to(['warehouse/index'],true)?>" method="post">
                                   ...
                                   // 'id',
                                    ...
                                    [
                                      ...
                                      'contentOptions' => ['style' => 'vertical-align: middle'],  
                                       'format' => 'html',
                                       'value'=>function($data){
                                         return $data->is_primary === 1 ? '<div class="label label-success"> Yes </div>':'<div class="label label-default"> No </div>';
                                       }
                                    ],
                                    [
                                   'attribute'=>'status',
