...
<div class="journaltable-form">
    <div class="x_panel">
                  <div class="x_title">
                    <h3><i class="fa fa-file-text"></i> <?=$this->title?> <small></small></h3>
                  ...
                  <div class="x_content">
                    <br />
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ชื่อสมุดบันทึก <span class="required">*</span>
                                </label>
                              ...
                              <div class="form-group">
                               ...
                               <div class="form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">ประเภทรายการ <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
