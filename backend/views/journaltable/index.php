...
/* @var $searchModel backend\models\JournaltableSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = Yii::t('app', 'สมุดบันทึกรายวัน');
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="journaltable-index">
   ...
   <div class="x_panel">
                  <div class="x_title">
                    <div class="btn-group">
                      <?= Html::a(Yii::t('app', '<i class="fa fa-plus"></i> สร้างสมุดบันทึก'), ['create'], ['class' => 'btn btn-success']) ?>
                    </div>
                    <h4 class="pull-right"><?=$this->title?> <i class="fa fa-list-ol"></i><small></small></h4>
                  ...
                  <div class="x_content">
                        <div class="row">
                          ...
                          <div class="col-lg-3">
                            ...
                            <form id="form-perpage" class="form-inline" action="<?=Url::to(['journaltable/index'],true)?>" method="post">
                                    ...
                                    ['class' => 'yii\grid\SerialColumn','contentOptions' => ['style' => 'vertical-align: middle']],
                                     [
                                        ...
                                        [
                                          ...
                                          'contentOptions' => ['style' => 'vertical-align: middle'],  
                                          'value'=>function($data){
                                             return $data->trans_type!=""?\backend\helpers\TransType::getTypeById($data->trans_type):"";
                                          }
                                        ],
